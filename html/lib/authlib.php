...
function signup_setup_new_user($user) {
    ...
    $namefields = array_diff(get_all_user_name_fields(), useredit_get_required_name_fields());
     //error_log('begin',3,'/var/www/html/lib/errorlog.txt');
     //error_log(var_export($user,true), 3, '/var/www/html/lib/errorlog.txt');
     //error_log('\n',3,'/var/www/html/lib/errorlog.txt');
     //error_log('begin',3,'/var/www/html/lib/errorlog.txt');
     //error_log(var_export($namefields,true), 3, '/var/www/html/lib/errorlog.txt');
     //error_log(var_export(useredit_get_required_name_fields(),true), 3, '/var/www/html/lib/errorlog.txt');
     //error_log('\n',3,'/var/www/html/lib/errorlog.txt');
