...
$necessarynames = array('username'/*, 'lastname'*/,'firstname');
...
//	print_r($nameformat);
    ...
    foreach ($necessarynames as $necessaryname) {
		...
		$languageformat = 'username firstname';
        }
     ...
     error_log('came through edited lib', 3, '/var/www/html/lib/errorlog.txt');
  //  print_r($nameformat);
