...
if (!empty($availableenrolids)) {
	...
	echo $OUTPUT->notification("Please check your email for an account confirmation email and click on the confirmation link in it. Thanks!", 'notifysuccess');
	
	if($data->role == 'Patient'){
		$data->href = (new moodle_url('/lib/pref.php', array('id' => $plugin->courseid)))->out();
	}	
