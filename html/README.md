...
## SMTP email client:
Currently using HUIT's email client that they provided the credentials for. If migrating off Harvard infrastructure will need a new SMTP email system, and to change it just search for SMTP in the search bar at the bottom of the navigation bar and change the credentials there.
